            ...
            try {
                ...
                setUserData({
                    ...
                    gender:
                        ...
                        gender_radio[0].label.toLowerCase()
                            ? "Male"
                            : "Female",
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.header}>
                        <Text style={styles.headerText}>
                            Mohon lengkapi semua data di bawah ini terlebih
                            dahulu
                        </Text>
                    </View>
                            ...
                            <View style={styles.inputMiddleContainer}>
                                ...
                                >
                                    ...
                                    <TouchableOpacity
                                        ...
                                        onPress={() =>
                                            updateSecureTextEntry("password")
                                        }
                                    >
                                        {secureTextEntry.password ? (
                                            <Feather
