...
import { setHealthFacility, checkIn } from "../../../stores/action/";
...
const Assistant_scan = (props) => {
    ...
    useEffect(async () => {
        if (isToday) {
            ...
            try {
                ...
                console.log(
                    error.message,
                    "this is error from scanner check in"
                );
            }
        }
    }, []);
    ...
    console.log(reservationData.healthFacility);
                    ...
                    <View>
                        ...
                        >
                            ...
                            <Text
                                ...
                                numberOfLines={2}
                            >
                                Untuk mendapatkan nomor antrian, silahkan datang
                                ke faskes yang Kamu tuju pada hari yang sudah
                                kamu pilih
                            </Text>
                        </View>
                    </View>
        ...
        <View style={{ flex: 1, backgroundColor: "#1F1F1F" }}>
            ...
            {loading ? (
                ...
                <View style={styles.thisContainer}>
                    <Camera
                        onBarCodeScanned={
                            !scanned ? handleBarCodeScanned : null
                        }
                        ratio="16:9"
                        style={[
