...
const ListApointment = (props) => {
    ...
    const getHealthFacility = async () => {
        const { data: response } = await axios({
            method: "POST",
            url: `${baseURL}detailFacility/${dataPatient.healthFacility.facilityID}`,
        });
                    ...
                    <View style={styles.container}>
                                ...
                                >
                                    <View>
                                        <Text style={styles.name}>
                                            {dataPatient.doctor.title}{" "}
                                            {dataPatient.doctor.doctorName}{" "}
                                        </Text>
                        ...
                        >
                            <TouchableOpacity
                                onPress={() => {
                                    if (
                                        typeof props.onCancelReservation ===
                                        "function"
                                    ) {
                                ...
                                {dataPatient.status == "need confirmation" ? (
                                  ...
                                  dataPatient.bookingSchedule !==
                                    ...
                                    >
                                        ...
                                        >
                                            QR codes only appear on the day you
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                Show the QR to the registration
                                                section when you arrive and get
                                                the queue number{" "}
                                            </Text>
                                            <Text
                                                style={{
